...
uint256 hashGenesisBlock("0x2208cd35051a120b0bc3f5b65baa9c3c7d59325e1c2b2870c5e3ec08a5a01dd4");
...
const string strMessageMagic = "ZennyCoin Signed Message:\n";
...
{
    int64 nSubsidy = (rand() % 4 + 1) * COIN;

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 60 * 60; // ZennyCoin: 1 hour
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal zennycoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ZennyCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x738914bb7fa3b748d4719707b329d724844182fbf4723dd2ff36a03699ce9713");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "1369623854";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1408917792; //epochtime
        ...
        assert(block.hashMerkleRoot == uint256("0x4935e064456d3b65b37ede09f7568546651251f18b39e9d5bfa187499e0daa83"));
